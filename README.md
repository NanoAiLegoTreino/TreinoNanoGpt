...
- `app.js`: timers basados en timestamps absolutos, notas, series, persistencia, Wake Lock, sonido, vibración y exportación.
...
- **Sonido:** el `AudioContext` se crea o reactiva tras tocar Iniciar/Reanudar, como exige Chrome Android. Los cambios de fase emiten un tono y los finales una secuencia de tres tonos.
- **Vibración:** acompaña al sonido si `navigator.vibrate` está disponible. No es el único aviso y puede estar deshabilitada por el sistema.
